...
sjis_table_rec_t sjis_table[] = {
    ...
    {"右袖", "right_sleave", {0x89, 0x45, 0x91, 0xb3, 0x00}},
    {"右袖先", "right_cuff", {0x89, 0x45, 0x91, 0xb3, 0x90, 0xe6, 0x00}},
    ...
    {"左袖", "left_sleave", {0x8D, 0xB6, 0x91, 0xb3, 0x00}},
    {"左袖先", "left_cuff", {0x8D, 0xB6, 0x91, 0xb3, 0x90, 0xe6, 0x00}},
